...
int main(){                                         // Menu principal [Bilal]
    ...
    printf("6 - la sauvegarde des donnees dans un fichierhier \n\n");
    ...
    printf("9 - l’affichage des trajets tries par chiffre d’affaires (difference entre les prix des billets payes par les passagers et le cout du trajet supporte par l’entreprise), avec affichage de ce chiffre d’affaires \n\n");
    printf("10 - La possibilite de supprimer tous les bus avec un chiffre d’affaires negatif, en repartissant les passagers sur les trajets identiques, en priorisant les passagers ayant paye le plus sur les dates et horaires les plus proches du trajet initial. Il faudra indiquer le gain genere par cette operation \n\n");
    printf("\n\n");
